...
npm run dev</code></pre>
        ...
        <p class="text-lg mb-4">
            Navigate to
            <i class="bg-highlight px-2 py-1 rounded-border not-italic text-base">http://localhost:5173/</i> to view the
        ...
        <p class="text-lg mb-4">
            Templates consists of a couple folders, demos and layout have been separated so that you can easily remove
            what is not necessary for your application.
        </p>
        ...
        <p class="text-lg mb-4">
            ...
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">src/layout/AppMenu.vue</span> file.
        ...
        <p class="text-lg mb-4">
            ...
            states. If you change the initial values like the preset or colors, make sure to apply them at PrimeVue
            config at main.js as well.
        </p>
...
<code>modules: [
    '@primevue/nuxt-module',
        ...
        <p class="text-lg mb-4">
            Add
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">tailwindcss-primeui</span> package
            as a plugin to
...
&lt;/template&gt;</code></pre>
        ...
        <p class="text-lg mb-4">
            Create
            <span class="bg-highlight px-2 py-1 rounded-border not-italic text-base">layouts/default.vue</span> and
            paste this code:
        </p>
        <pre class="app-code">
<code>&lt;script setup&gt;
